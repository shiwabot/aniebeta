...
@tbot.on(events.NewMessage(pattern="/lowpromote ?(.*)"))
...
@tbot.on(events.NewMessage(pattern="/midpromote ?(.*)"))
...
@tbot.on(events.NewMessage(pattern="/highpromote ?(.*)"))
...
@tbot.on(events.NewMessage(pattern="/lowdemote(?: |$)(.*)"))
...
@tbot.on(events.NewMessage(pattern="/middemote(?: |$)(.*)"))
...
@tbot.on(events.NewMessage(pattern="/users$"))
...
@tbot.on(events.NewMessage(pattern="/banme$"))
async def banme(bon):
    if not bon.is_group:
        return
...
@tbot.on(events.NewMessage(pattern=r"/setdescription ([\s\S]*)"))
...
@tbot.on(events.NewMessage(pattern="/setsticker$"))
