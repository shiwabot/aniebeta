...
__help__ = """
 • `/song <song name>`*:* Anie will send you song as per your request
 • `/song <youtube-song-url>`*:* Anie will send you song as per your request with link

`Simple Fixed Module By noobanon!`
"""
