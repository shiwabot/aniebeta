...
# __main__
	"Ada yang bisa saya bantu? 😊": "Hey need any help? do /help to know more",
	"start_text": """
Hi {}, my name is {}! I am a group manager managed by [my master](tg://user?id={}).
To get this bot status info and update, you can join our channel [Yuko Araki'News](https://t.me/XpIoitCrew)

If you're enjoying using me, wanna donate something? feed any poor person donate them i feel good🙂
""",
	"help_text": """
Hey there! My name is *Yuko*.
...
Need a lot of work for [my creator](tg://user?id=631847622) to take me to my place now, and \
every donation helps and motivates him to make someones life better.

All donated money will be given to a poor guys. \
They are a ordinary person, so it will really help him!
...
*Creator Only*
 - /unbanall: unban all user at once in chat
*Admin only:*
 ...
 - /tagall tag all/admins users in chat
 - /promote: promotes the user replied to
 - /demote: demotes the user replied to
 - /set : it will set title custom title if promoted by bot
 Example : /set @username Super or reply with his message 
""",
...
The generated file is in standard JSON format *Rose bot chat also support* , so if there are any settings you dont want to import to your other chats, just open the file and edit it before importing.

It is recommended to use this command in a private session with Yuko. To do this, see the /help regarding connections.

Available commands are:
 - /export: generates a file containing all of the chats settings
 - /import: imports the settings contained in the JSON file that you've replied to.

Note: To avoid abuse, this command is heavily rate limited you can import data every 12hrs; this is to make sure that people importing/exporting data don't slow down the bot..
""",
...
*Admin only:*
 ...
 -/unbanall unban all user at once in your chat {Creator Only}
 - /dban same as ban + bot will delete the replied message
...
*NOTE:* blacklists do not affect group admins.
 - /blocklist: View the current blacklisted words.
...
multiple triggers at once.
 - /blocklisthelps: Get All Blocklist Example Here
 - /blocklistmode dlt/kick/mute/tban/ban/tban Example `/blacklistmode kick`
...
""",
	...
	"/save test This is a test markdown. _miring_, *thick*, `code`, [URL](contoh.com) [button](buttonurl:github.com) [button2](buttonurl:google.com:same)": "/save test This is a markdown test. _italics_, *bold*, `code`, [URL](example.com) [button](buttonurl:github.com) [button2](buttonurl:google.com:same)",
	"Statistic moment ini:\n": "Current stats:\n",
	"misc_help": """
...
*Chat Creator Only*
 - /unmuteall unmuteall users at once in chat
""",
...
*Admin only:*
 ...
 - /dwarn same as warn but targeted message will auto delete
 - /resetwarn <userhandle>: reset the warnings for a user. Can also be used as a reply.
 - /addwarn <keyword> <reply message>: set a warning filter on a certain keyword. If you want your keyword to \
be a sentence, encompass it with quotes, as such: `/addwarn "very angry" This is an angry user`. 
 - /nowarn <keyword>: stop a warning filter
 - /warnlimit <num>: set the warning limit
 - /setwarnmode <kick/ban/mute>: Set warn mode, when user exceeding the warn limit will result in that mode.
""",
...
*Admin only:*
 ...
 - /resetmutetext: Reset mute text to default.
...
Read /welcomehelp and /markdownhelps to learn about formatting your text and mentioning new users when the join!
